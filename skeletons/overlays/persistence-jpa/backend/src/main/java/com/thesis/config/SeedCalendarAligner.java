...
public class SeedCalendarAligner implements ApplicationRunner {
    ...
    private static List<String[]> discover(JpaDb jdbc) {
    ...
    private static LocalDate minDate(JpaDb jdbc, String table, String col, LocalDate floor) {
        try {
            return jdbc.query(
