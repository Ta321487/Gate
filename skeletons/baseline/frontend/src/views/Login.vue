...
onMounted(async () => {
  ...
  if (route.query.reason === 'disabled') {
    ElMessage.warning('账号已停用，请联系管理员')
  }
...
.submit {
  margin-top: 8px;
  height: var(--portal-control-h, 44px) !important;
  border-radius: var(--portal-btn-radius, 10px) !important;
  font-weight: 600;
