  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        title: '论文材料',
        tag: '产物',
        lead: '「产物 / 对照 → 论文材料」：功能模块图、系统逻辑架构图、系统类图、系统序列图、用例图、用例描述表与软件测试用例。模块图按身份以交付菜单为叶子真源，开题枚举只辅助命名（未交付不进图）；类图按 schema.sql 外键 + bake 包 Java（三栏 UML、+/-/#、六种关系线、零交叉；默认论文示例可切代码全量；拖拽后回拉重选折线）；序列图固定 3 张核心功能（可勾选交付菜单），四槽位画法，文案取自 bake；用例图按角色走查菜单；描述表默认阐述 4 个主路径；测例按交付菜单推导。',
        bullets: [
    ...
    cards: [
      {
        ...
        terms: [
          ...
          { name: '论文材料', def: '功能模块图、系统逻辑架构图、系统类图、系统序列图、用例图、用例描述表与软件测试用例；位于「产物 → 论文材料」。类图按交付 SQL/Java 画三栏 UML（六种关系、零交叉）；序列图固定 3 张、可勾选交付功能、文案取自 bake；其余按交付菜单与开题材料推导。' },
