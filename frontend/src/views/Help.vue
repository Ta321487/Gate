    ...
    cards: [
      {
        title: '产品定位',
        tag: '总览',
        lead: '毕设港工作台用于依据开题、任务书等材料完成选题匹配、工程生成、质量检查与本地预览；机器质检通过后可下载压缩包，人工审核后标记可交付，发给学生后标记已交付。',
        bullets: [
      ...
      },
      {
        ...
        tag: '规范',
        bullets: [
          '请勿将未通过质量检查、或尚未人工标记「可交付」的工程作为最终交付物提供给学生或指导教师。',
    ...
    cards: [
      {
        ...
        steps: [
          ...
          {
            title: '交付',
            body: '机器质检通过后可下载 ZIP。人工审核文案与主流程后标记「可交付」；发给学生后再标记「已交付」。重新生成会清掉人工标记。',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        tag: '交付',
        wide: true,
        lead: '机器质检通过只代表可下载。主流程或功能清单等关键项未通过时不可下载，以防不合格工程外发；文案与逻辑须人工审核后再标记可交付。',
        bullets: [
    ...
    cards: [
      {
        ...
        terms: [
          ...
          { name: '领域', def: '题目所属业务域。决定文案、菜单与能力组合，与骨架配合使用。合成壳不是行业域，仅作无贴切领域或需多主路径拼装时的回落。' },
