    ...
    cards: [
      {
        ...
        steps: [
          ...
          {
            title: '一键生成',
            body: '匹配确认后，在「一键生成」页调整视觉与生成选项（即时保存），再启动生成。生成完成后可同页改选项并「按当前选项重新生成」。进度可在「任务队列」与项目详情中查看；业务配置填充会拆成多个 Unit 并发执行，详情见「大模型与填岛拆解」。',
          },
          {
            title: '预览与验收',
          ...
          {
            title: '交付',
            body: '机器质检通过后可下载 ZIP。列表「履约」列或详情页头可操作：审过可一步「标记已发出」；暂存用「已审待发」，发出时用「下载并发出」。重新生成会清掉人工标记。',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        tag: '交付',
        wide: true,
        lead: '机器质检通过只代表可下载。关键项未通过时不可下载。人工审核后可在列表或详情直接标「已发出」；需要暂存待发再用「已审待发」。',
        bullets: [
