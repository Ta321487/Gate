...
const cards = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '预览与验收',
        body: '于「运行」页启动前后端预览做快速验收；于「产物 / 对照」页核对质量检查、表结构、论文材料（功能模块图 / 软件测试用例）、学生端 API 与 E-R 图。',
      },
      {
        title: '交付',
  ...
  },
  {
    title: '论文材料',
    tag: '产物',
    lead: '「产物 / 对照 → 论文材料」提供可贴说明书的功能模块图与软件测试用例表，均按交付菜单 / 角色推导，不发明功能。',
    bullets: [
      '功能模块图可按业务或按端切换；黑白线框，可复制 PNG 或下载矢量；可选大模型只微调节点中文名。',
      '软件测试用例 5～9 字段可选（默认 6）；可复制表格 / Markdown；大模型仅润色步骤/预期等文案，不增删用例。',
      '与质量检查相互独立：论文材料便于贴文档，交付闸门仍以质量检查为准。',
    ],
  },
  {
    title: '学生端 API',
  ...
  },
  {
    ...
    terms: [
      ...
      { name: '匹配确认', def: '核验并锁定推荐骨架与领域。确认前不可正式生成；改动后须重新确认。视觉与生成选项在「一键生成」页调整。' },
      { name: '生成配置', def: '描述业务配置的结构化数据（内部亦称 Spec / Schema）。大模型主要填充此类配置，而非手写业务代码。' },
      { name: '视觉与生成选项', def: '配色、质感、布局、字体、智能填充与密码策略等软项；在「一键生成」页调整并即时保存，写入工程须重新生成。' },
