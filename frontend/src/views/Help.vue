    ...
    cards: [
      {
        ...
        steps: [
          ...
          {
            title: '匹配确认',
            body: '在「匹配确认」页核验推荐骨架、领域、身份场景、主路径入口（如有分叉：晨午检自报/绑岗/调宿等）、持久层，以及按需开关（Spring Security、AI 助手）。开题未写清「谁怎么用」时须勾选「主路径已核对」或解锁手改后再确认。配色、布局等视觉选项在「一键生成」页调整；技术栈与 AI 开关不要放进视觉区。',
          },
          {
            title: '一键生成',
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        title: '论文材料',
        tag: '产物',
        lead: '「产物 / 对照 → 论文材料」：功能模块图与软件测试用例。模块图优先读材料按身份枚举；测例按交付菜单推导。',
        bullets: [
