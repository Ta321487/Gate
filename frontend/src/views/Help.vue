    ...
    cards: [
      {
        title: '产品定位',
        tag: '总览',
        lead: '毕设港工作台用于依据开题、任务书等材料完成选题匹配、工程生成、质量检查与本地预览；机器质检通过后可下载压缩包。人工审核后可直接标记已交付，或先标可交付再发出。',
        bullets: [
      ...
      },
      {
        ...
        tag: '规范',
        bullets: [
          '请勿将未通过质量检查的工程作为最终交付物提供给学生或指导教师；发出前请完成人工审核并标记「已交付」（或先「可交付」暂存）。',
    ...
    cards: [
      {
        ...
        steps: [
          ...
          {
            title: '交付',
            body: '机器质检通过后可下载 ZIP。列表「履约」列或详情页可直接操作：审过可一步「标记已交付」；若要暂存待发则「标记可交付」，发出时用「下载并标已交付」。重新生成会清掉人工标记。',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        tag: '交付',
        wide: true,
        lead: '机器质检通过只代表可下载。关键项未通过时不可下载。人工审核后可在列表或详情直接标「已交付」；需要暂存待发再用「可交付」。',
        bullets: [
          '检查明细见项目详情「产物 / 对照」中的「质量检查」。',
          '项目列表顶部「待审 / 可交付 / 已交付」可点开 backlog；履约列无需进详情即可下载与标记。',
    ...
    cards: [
      {
        ...
        terms: [
          ...
          { name: '持久层', def: '匹配确认中的数据访问实现：JdbcTemplate 或 MyBatis（绑 PageHelper）。只换实现与说明书措辞，不换业务能力；与骨架、领域同级，独立于视觉选项。' },
