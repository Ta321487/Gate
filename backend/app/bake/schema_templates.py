    ...
    return _with_portal_banners(
        _archive_ticket_schema(
            ...
            archive_fields=[
                ...
                {"key": "isbn", "label": "地点/时段", "type": "string"},
                {"key": "category", "label": "分类", "type": "string"},
            ...
            users_menu="用户管理",
            auth_eyebrow="活动报名",
            auth_lead="验证码登录；浏览社团与志愿活动，在线报名，管理员审核占名额。",
            auth_points=["验证码登录", "活动检索", "报名审核与名额"],
            register_hint="注册后可报名校园活动",
            notice_title="报名须知",
            notice_body="请如实填写资料；名额有限，审核通过后请按时参加。",
        ...
        [
            ...
            {"title": "名额提示", "lead": "审核通过后占用名额，请勿重复报名。"},
...
def _course_schema(title: str) -> dict[str, Any]:
    return _with_portal_banners(
        _archive_ticket_schema(
            ...
            users_menu="学生管理",
            auth_eyebrow="公选选课",
            auth_lead="验证码登录；浏览公选课，提交选课申请，审核通过后占用名额。",
            auth_points=["验证码登录", "课程检索", "选课与名额"],
            register_hint="注册后可以学生身份选课",
            notice_title="选课须知",
            notice_body="请在开放时段内选课；名额有限，审核通过后请按时上课。",
        ...
        [
            {"title": "本学期公选", "lead": "按分类浏览课程与剩余名额。"},
            {"title": "选课流程", "lead": "提交申请 → 审核通过 → 占用名额。"},
