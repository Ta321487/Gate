...
DOMAINS: dict = {
    "DOM-ACTIVITY": {
        "label": "活动报名",
        "keywords": [
            "社团活动", "志愿活动", "志愿者", "志愿服务", "活动报名", "讲座报名",
            "活动管理", "报名系统", "社团报名", "志愿报名", "讲座志愿",
            "三下乡", "培训班报名", "证书报考", "四六级报名",
            "研学报名", "夏令营报名", "赛事报名",
            "票务报名", "领票", "演出票务", "景区票务",
            "献血报名", "开放日报名",
            "投票报名", "报名投票", "活动投票", "评选报名",
        ...
        "match_hint": (
            "适用：社团/志愿/讲座/三下乡/研学/夏令营/赛事等活动报名审核（占名额，非学分）；"
    ...
    "DOM-COURSE": {
        "label": "选课",
        "keywords": ["选课", "公选课", "课程报名", "学分", "选课系统", "课程管理", "学分名额"],
        "match_hint": (
            "适用：公选课、课程选课占名额与学分。"
