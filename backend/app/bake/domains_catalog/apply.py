...
DOMAINS: dict = {
    "DOM-ACTIVITY": {
        ...
        "keywords": [
            ...
            "社团报名", "志愿报名", "三下乡",
            "证书报考", "四六级报名",
            "研学报名", "赛事报名", "大赛报名", "开放日报名", "军训",
            "演出票务", "献血报名", "献血管理", "防暴恐培训", "歌剧院",
        ],
        "match_hint": (
            "适用：社团/志愿/讲座/三下乡/研学/夏令营/赛事/大赛/军训等活动报名审核（占名额，非学分）；"
            "证书报考/四六级/培训班名额报名、景区/歌剧院演出领票、献血报名或献血管理、开放日报名、"
            "防暴恐/安全培训报名亦挂本域。"
            ...
            "勿与影院选座购票座位图下单（影院选座）混淆——歌剧院/演出领票报名≠座位图购票。"
    ...
    "DOM-LOST": {
        ...
        "match_hint": (
            "适用：失物招领、认领审核；题名含宠物/流浪动物领养或救助领养时走领养申请皮（同认领壳）；"
            "捐赠物资认领、航班/出行行李挂失认领亦挂本域（演示级启事认领，无RFID/全航迹追踪）。"
            "勿与商城二手交易、宠物医院挂号、事件上报或驿站取件（DOM-PARCEL）混淆。"
        ),
