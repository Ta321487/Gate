...
DOMAINS: dict = {
    "DOM-HOSPITAL": {
        ...
        "keywords": [
            "挂号", "就诊", "门诊", "就医", "诊疗", "分诊",
            "宠物挂号", "校医院", "号源预约", "复诊预约",
            "疫苗预约", "HPV", "疫苗接种预约", "疫苗及注射",
            "窗口取号", "政务预约", "银行预约",
            "体检预约", "入职体检", "探视预约",
        ],
        "match_hint": (
            "适用：挂号预约、门诊分诊、号源/复诊改约、疫苗/HPV 接种预约或疫苗注射管理、入职体检套餐预约；"
            "题名含宠物+挂号时走宠物医院挂号皮；政务/银行/车管窗口取号、医院/养老探视预约亦挂本域（复用号源时段壳）。"
    ...
    "DOM-PARKING": {
        "label": "车位",
        "keywords": [
            "车位", "停车", "预约车位", "泊车", "停车场", "停车管理", "车位预约", "停车位",
            "充电桩", "共享车位",
        ],
        "match_hint": (
            "适用：停车场车位时段预约；充电桩/共享车位长尾亦挂本域。"
            "勿与场地预约（会议室/球馆）、客房预订、车辆通行证/车牌备案或四轮商业租车（DOM-CARRENT）混淆。"
        ),
    ...
    "DOM-MEETING": {
        ...
        # 词表预算 ≤20：只留硬分流；博物馆/党史馆/订场/创客等长尾见 match_hint
        "keywords": [
            "会议室", "琴房", "排练厅", "舞蹈室",
            "体育馆", "球馆", "羽毛球场",
            "自习室", "研讨室", "研讨隔间", "隔间预约",
            "座位预约", "占座", "预约占座", "图书馆座位",
            "工位预约", "工位短租", "场地预约", "游泳馆", "参观预约",
        ],
        "match_hint": (
            "适用：会议室、球馆、琴房、自习室、研讨隔间、座位/占座、工位/短租、游泳馆等场地时段预约；"
            "博物馆/党史馆/展览参观预约、实验室/实训室订场、创客工位、篮球场亦挂本域。"
            "勿与影院选座购票（影院选座）、车位预约、服务预约（美发/健身/心理咨询）"
            "或大型仪器机时（DOM-INSTRUMENT 借+约）混淆。"
        ),
    ...
    "DOM-SALON": {
        ...
        "match_hint": (
            "适用：美发美容、健身私教、约拍选摄影师、猫咖/宠物咖啡馆到店、洗衣到店等服务项目时段预约；"
            "心理咨询/辅导室面询、驾校练车/陪驾、家政上门、家教辅导、美甲推拿、瑜伽亦挂本域。"
            "勿与场地预约（会议室/球馆/座位）、医院挂号或物业报修工单混淆。"
            "课时包、消课、剩余课时仍走本域私教预约，勿与时间银行时长账户或选课学分混淆。"
        ),
    ...
    "DOM-HOTEL": {
        "label": "客房",
        "keywords": ["宾馆", "客房", "酒店", "民宿", "酒店预订", "住宿预订", "客栈", "旅馆", "客房预订", "寄养"],
        "match_hint": (
            "适用：酒店/民宿/宾馆客房预订履约，以及宠物寄养按天入住（单域）。"
            "勿与会议室场地预约、房源中介带看跟进、四轮商业租车（DOM-CARRENT）、宠物领养、宠物挂号、宠物咖啡或商城交易拼装混淆；"
            "宾馆+会议室+商城三合一仍拒绝。"
        ),
