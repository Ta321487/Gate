...
DOMAINS: dict = {
    "DOM-SHOP": {
        "label": "商城",
        # 词表预算 ≤20；网购/零售近义等长尾见 match_hint
        "keywords": [
            "商城", "商品", "购物车", "下单", "电商",
            "二手", "二手交易", "闲置交易", "转卖",
            "文印", "打印店",
        ...
        "match_hint": (
            "适用：商品浏览、购物车下单交易；校园二手/闲置/转卖、文印打印、农资/农产品/特产鲜花零售、"
            "药店/日用/汽配/宠物用品等社会零售、积分兑换商城、校园跑腿代买（订单向）亦挂本域。"
            "旧书回收、估价、上门回收后上架仍走本域，勿落图书借阅。"
            "多商家入驻/店铺审核仍挂本域（交易壳内附属审核，非独立单据域）。"
