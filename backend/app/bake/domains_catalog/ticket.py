...
DOMAINS: dict = {
    ...
    "DOM-PROPERTY": {
        ...
        "keywords": [
            ...
            "校园物业", "学生公寓", "高校物业", "宿舍物业",
            "投诉建议", "物业投诉", "业主投诉", "信访工单",
            "市政报修", "路灯报修", "井盖报修", "路灯", "井盖",
        ],
        "match_hint": (
            "适用：物业/社区/小区报修工单；或校园公寓/高校物业报修；"
            "业主投诉建议、市政路灯/井盖报修亦可走本域工单类型。"
            "勿与宿舍专项报修或 IT 报修混淆；独立「投诉专版」深皮见换皮清单 S-21。"
        ),
        ...
        "features": [
            ...
            {"name": "个人资料与头像", "status": "baseline"},
            {"name": "管理端工作台", "status": "module"},
            {"name": "位置管理", "status": "module"},
            {"name": "工单类型管理", "status": "module"},
            {"name": "用户管理", "status": "module"},
            {"name": "工单申请 → 受理", "status": "flow"},
            {"name": "工单记录", "status": "module"},
            {"name": "公告管理", "status": "module"},
        ],
        "out_of_mvp": [],
        "themes": [
        ...
        "gate": gate_standalone_ticket(
            flow_feature="工单申请 → 受理",
            records_feature="工单记录",
            users_feature="用户管理",
            site_feature="位置管理",
            type_feature="工单类型管理",
        ),
    ...
    "DOM-IT": {
        ...
        "match_hint": (
            "适用：校园网、机房、终端/邮箱/账号故障报修；设备维保、客服/售后工单亦可挂靠。"
            "勿与宿舍/物业报修或纯投诉建议专版混淆；巡检打卡走事件上报。"
        ),
