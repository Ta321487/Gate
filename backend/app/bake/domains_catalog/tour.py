...
DOMAINS: dict = {
    "DOM-TOUR": {
        ...
        "match_hint": (
            "适用：旅行社线路/团期产品档案、游客报名占名额、计调审核确认报名（无地图/真支付）。"
            "线路「已出团/下架」为档案状态手标，勿与酒店民宿客房预订、校园社团活动报名、拼车结伴行程、公务出差审批或商城套餐下单混淆。"
        ),
        "entities": ["Archive", "Category", "Signup", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览线路 → 提交报名 → 审核确认占名额（可取消回补）；线路已出团/下架在档案标注"],
        "features": [
