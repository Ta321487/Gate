...
DOMAINS: dict = {
    "DOM-MEDIA": {
        "label": "影视综",
        "keywords": [
            "影视", "电影", "电视剧", "综艺", "视频点播", "在线视频", "片库", "校园媒资", "教学片",
            "点播课", "课程视频", "视频库",
        ],
        "match_hint": (
            "适用：影视综点播、片单收藏；含校园媒资、点播课/课程视频库（非选课占名额）。"
            "勿与影院选座购票（影院选座）、音乐（歌曲曲库）、博客（文章 CMS）或公选课选课混淆。"
        ),
    ...
    "DOM-MUSIC": {
        "label": "音乐",
        "keywords": ["音乐", "歌曲", "歌单", "在线音乐", "音乐播放器", "听歌", "曲库", "点歌台", "点歌"],
        "match_hint": (
            "适用：在线音乐曲库、歌单收藏、点歌台（非直播）。"
            "勿与影视综或博客混淆。"
        ),
        "entities": ["Track", "Category", "Favorite", "Guestbook", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览曲库 → 播放 → 收藏"],
        "features": [
            {"name": "登录", "status": "baseline"},
    ...
    "DOM-FORUM": {
        ...
        "match_hint": (
            "适用：BBS 论坛发帖回帖审核；含校园论坛、表白墙/树洞或兴趣/小区社区。"
            "勿与博客（单向文章收藏）混淆。"
        ),
    ...
    "DOM-BLOG": {
        "label": "博客",
        "keywords": [
            "博客", "个人博客", "文章系统", "资讯发布", "CMS", "博文",
            "院刊", "校园资讯", "记者站", "广播稿", "稿件发布",
        ],
        "match_hint": (
            "适用：个人博客/博文浏览收藏；校园院刊/学工资讯、记者站/广播稿件发布亦挂本域。"
            "勿与论坛（回帖互动）或影视综混淆。"
            "勿与制度/课件文库下载台账（文库资料）混淆——资讯阅读≠附件下载台账。"
        ),
