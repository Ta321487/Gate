...
{"id": "carpass-night", "label": "车辆通行证深色"}
    ...
    "DOM-LISTING": {
        "label": "房源带看",
        "keywords": ["房源中介", "带看跟进", "房源挂牌", "租房带看", "二手房带看", "房源意向", "中介带看"],
        "match_hint": ("适用：房源挂牌与带看/意向跟进单据（非酒店客房预约、非二手商城成交）。勿与酒店预约或二手交易混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览房源 → 登记意向 → 审"],
        "features": [
...
{"id": "listing-night", "label": "房源带看深色"}
    ...
    "DOM-PROCURE": {
        "label": "采购申购",
        "keywords": ["采购申请", "申购单", "物资申购", "采购审批", "办公用品申购", "设备申购", "采购申请单"],
        "match_hint": ("适用：采购/申购单填报与审批台账（无真电商下单）。勿与资产领用或经费报销混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览采购品目 → 提交申购 → 审"],
        "features": [
...
{"id": "procure-night", "label": "采购申购深色"}
    ...
    "DOM-CLUB": {
        "label": "社团年审",
        "keywords": ["社团注册", "社团年审", "学生社团成立", "社团备案", "社团注册年审", "社团审批"],
        "match_hint": ("适用：学生社团成立注册/年审材料提交与审批（非活动报名占名额）。勿与社团活动报名或经费资助混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览社团事项 → 提交材料 → 审"],
        "features": [
...
{"id": "club-night", "label": "社团年审深色"}
    ...
    "DOM-PROJ": {
        "label": "项目申报",
        "keywords": ["项目申报", "大创中期", "大创检查", "创新创业项目申报", "科研项目申报", "项目中期检查", "大创申报"],
        "match_hint": ("适用：大创/科研等项目申报与中期检查单据审核。勿与经费报销或单纯资助申请混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览申报项目 → 提交申报 → 审"],
        "features": [
...
{"id": "proj-night", "label": "项目申报深色"}
    ...
    "DOM-ETHIC": {
        "label": "材料审核",
        "keywords": ["伦理审查", "开题答辩材料", "开题材料审核", "伦理材料", "答辩材料审核", "人因伦理", "开题审核"],
        "match_hint": ("适用：伦理审查/开题答辩等材料提交与单级审核。勿与成绩更正或实验室准入考试混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览审核事项 → 提交材料 → 审"],
        "features": [
...
{"id": "ethic-night", "label": "材料审核深色"}
    ...
    "DOM-PARTY": {
        "label": "党员发展",
        "keywords": ["党员发展", "入党申请", "积极分子", "发展对象", "入党积极分子", "党员发展台账", "入党材料"],
        "match_hint": ("适用：入党申请/积极分子等发展阶段材料提交与审批台账。勿与党建答题考试或活动报名混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览发展阶段 → 提交材料 → 审"],
        "features": [
...
{"id": "party-night", "label": "党员发展深色"}
    ...
    "DOM-CONTRACT": {
        "label": "合同审批",
        "keywords": ["合同审批", "合同登记", "合同审核", "单级合同审批", "采购合同审批", "合作协议审批"],
        "match_hint": ("适用：合同/协议登记与单级审批（非多级会签引擎）。勿与用章申请或客户跟进（CRM）混淆。"),
        "entities": ["Archive", "Category", "Ticket", "Notice"],
        "roles": ["user", "admin", "subadmin"],
        "flows": ["浏览合同类型 → 提交合同 → 审"],
        "features": [
