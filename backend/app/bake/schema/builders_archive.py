    ...
    return _with_portal_banners(
        archive_ticket_schema(
            ...
            archive_fields=[
                ...
                # 截止默认只要日；开题强调时分时由 temporal_field 升 datetime
                {"key": "applyDeadlineAt", "label": "报名截止", "type": "date"},
...
def _lost_schema(title: str, proposal_text: str = "") -> dict[str, Any]:
    ...
    return archive_ticket_schema(
        ...
        archive_fields=[
            ...
            {"key": "foundAt", "label": found_lab, "type": "date"},
            {"key": "category", "label": "分类", "type": "select"},
    ...
    return _with_portal_banners(
        archive_ticket_schema(
            ...
            archive_fields=[
                ...
                {"key": "applyDeadlineAt", "label": "选课截止", "type": "date"},
