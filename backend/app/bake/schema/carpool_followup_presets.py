    ...
    return {
        "DOM-CARPOOL": {
            ...
            "archive_fields": [
                ...
                {"key": "isbn", "label": "时间地点备注", "type": "string"},
            ...
            "auth_eyebrow": "拼车结伴",
            "auth_lead": "验证码登录；发布行程或提交同行意向，由车主确认或婉拒；管理端可调剂（无地图）。",
            "auth_points": ["验证码登录", "行程发布", "意向对接与车主确认"],
            "register_hint": "注册后可发布行程并提交同行意向",
            "notice_title": "拼车须知",
            "notice_body": "请如实填写同行说明；确认后占用余座。本期无地图导航与真支付分账。",
            ...
            "banners": [
                ...
                {"title": "发布行程", "lead": "登录后发布本人行程，即时可见。"},
