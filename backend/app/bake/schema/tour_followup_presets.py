...
def build_tour_followup_presets(
    ...
    return {
        "DOM-TOUR": {
            ...
            "auth_eyebrow": "旅行社线路",
            "auth_lead": "验证码登录；浏览线路并提交报名，计调审核确认后占余位；过截止、满员、已出团或下架不可再报（无地图/真支付）。",
            "auth_points": ["验证码登录", "线路浏览", "报名审核"],
            "register_hint": "注册后可提交线路报名",
            "notice_title": "报名须知",
            "notice_body": "请如实填写出行人数与联系方式；余位有限，过报名截止将无法提交；取消报名将回补余位；线路「已出团/下架」由计调在档案标注；本期无地图导航、OTA 同步与真支付。",
