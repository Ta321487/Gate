...
_DOMAIN_JAVA: dict[str, tuple[str, str, str]] = {
    ...
    "DOM-CRM": ("com.biz.crm", "CrmApplication", "crm-app"),
    ...
    "DOM-SEAL": ("com.campus.seal", "SealApplication", "seal-app"),
    "DOM-FLEET": ("com.campus.fleet", "FleetApplication", "fleet-app"),
    "DOM-CERT": ("com.campus.cert", "CertApplication", "cert-app"),
    "DOM-PROMO": ("com.campus.promo", "PromoApplication", "promo-app"),
    "DOM-FITOUT": ("com.campus.fitout", "FitoutApplication", "fitout-app"),
    "DOM-ACAD": ("com.campus.acad", "AcadApplication", "acad-app"),
    "DOM-TRIP": ("com.campus.trip", "TripApplication", "trip-app"),
    "DOM-EXPENSE": ("com.campus.expense", "ExpenseApplication", "expense-app"),
    "DOM-CREDIT": ("com.campus.credit", "CreditApplication", "credit-app"),
    "DOM-LABOR": ("com.campus.labor", "LaborApplication", "labor-app"),
    "DOM-EVAL": ("com.campus.eval", "EvalApplication", "eval-app"),
    "DOM-MORAL": ("com.campus.moral", "MoralApplication", "moral-app"),
    ...
    "DOM-MUTUAL-TUTOR": ("com.campus.tutor", "TutorApplication", "tutor-app"),
    "DOM-MUTUAL-TOPIC": ("com.campus.topic", "TopicApplication", "topic-app"),
    "DOM-MUTUAL-TEAM": ("com.campus.team", "TeamApplication", "team-app"),
    "DOM-VISITOR": ("com.campus.visitor", "VisitorApplication", "visitor-app"),
    "DOM-CARPASS": ("com.campus.carpass", "CarpassApplication", "carpass-app"),
    "DOM-LISTING": ("com.campus.listing", "ListingApplication", "listing-app"),
    "DOM-PROCURE": ("com.campus.procure", "ProcureApplication", "procure-app"),
    "DOM-CLUB": ("com.campus.club", "ClubApplication", "club-app"),
    "DOM-PROJ": ("com.campus.proj", "ProjApplication", "proj-app"),
    "DOM-ETHIC": ("com.campus.ethic", "EthicApplication", "ethic-app"),
    "DOM-PARTY": ("com.campus.party", "PartyApplication", "party-app"),
    "DOM-CONTRACT": ("com.campus.contract", "ContractApplication", "contract-app"),
    "DOM-INSTRUMENT": ("com.campus.instrument", "InstrumentApplication", "instrument-app"),
    "DOM-EXAM": ("com.campus.exam", "ExamApplication", "exam-app"),
    "DOM-SURVEY": ("com.campus.survey", "SurveyApplication", "survey-app"),
    ...
    "DOM-CARRENT": ("com.campus.carrent", "CarrentApplication", "carrent-app"),
