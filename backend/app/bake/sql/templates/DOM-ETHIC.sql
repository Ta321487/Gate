-- bake domain=DOM-ETHIC · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS ethic_item (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ethic_apply (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS ethic_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  ethic_apply_id BIGINT NOT NULL,
...
INSERT IGNORE INTO category (id, name) VALUES (1, '伦理审查'), (2, '开题材料'), (3, '答辩材料');
INSERT IGNORE INTO ethic_item (id, title, author, isbn, category_id, stock, status) VALUES
(1, '人因伦理审查', '科研处', '知情同意等', 1, 1, 'available'),
