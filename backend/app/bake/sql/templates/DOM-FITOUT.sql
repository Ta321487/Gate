-- bake domain=DOM-FITOUT · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS fitout_site (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS fitout_apply (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS fitout_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  fitout_apply_id BIGINT NOT NULL,
...
('admin', 'admin123', 'admin', '工程主管', '13800000000', '{}', 1, 0, 1),
('subadmin', 'sub123', 'admin', '备案员', '13800000001', '{}', 0, 1, 1),
