-- bake domain=DOM-FLEET · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS fleet_apply (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS fleet_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  fleet_apply_id BIGINT NOT NULL,
...
('admin', 'admin123', 'admin', '车队主管', '13800000000', '{}', 1, 0, 1),
('subadmin', 'sub123', 'admin', '调度员', '13800000001', '{}', 0, 1, 1),
('user', 'user123', 'user', '用车人甲', '13800000002',
...
SELECT '用车申请须知', '请如实填写用车事由、人数与目的地；审批通过后方可出车。', 'admin', '车队主管'
