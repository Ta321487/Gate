-- bake domain=DOM-AWARD · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS award_apply (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS award_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  award_apply_id BIGINT NOT NULL,
...
('subadmin', 'sub123', 'admin', '成果专员', '13800000001', '{}', 0, 1, 1),
...
INSERT IGNORE INTO category (id, name) VALUES (1, '学科竞赛'), (2, '创新创业'), (3, '学术论文');
INSERT IGNORE INTO award_item (id, title, author, isbn, category_id, stock, status) VALUES
(1, '省级编程竞赛', '教务处', '一等奖可认定', 1, 1, 'available'),
(2, '大创结题登记', '科研处', '结题证明', 2, 1, 'available'),
(3, '公开发表论文', '科研处', '需检索证明', 3, 1, 'available'),
