-- bake domain=DOM-CREDIT · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS credit_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  credit_apply_id BIGINT NOT NULL,
...
('subadmin', 'sub123', 'admin', '认定专员', '13800000001', '{}', 0, 1, 1),
