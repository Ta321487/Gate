-- bake domain=DOM-MUTUAL-TOPIC · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS topic_wish (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS topic_wish_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  topic_wish_id BIGINT NOT NULL,
