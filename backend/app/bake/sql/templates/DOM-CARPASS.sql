-- bake domain=DOM-CARPASS · tables in [${TABLE_COUNT_MIN},${TABLE_COUNT_MAX}]
...
CREATE TABLE IF NOT EXISTS pass_zone (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS carpass_apply (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS carpass_apply_log (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  carpass_apply_id BIGINT NOT NULL,
...
('subadmin', 'sub123', 'admin', '车证管理员', '13800000001', '{}', 0, 1, 1),
...
INSERT IGNORE INTO category (id, name) VALUES (1, '校门通行'), (2, '施工车辆'), (3, '访客车辆');
INSERT IGNORE INTO pass_zone (id, title, author, isbn, category_id, stock, status) VALUES
(1, '东门通行区', '保卫处', '工作日 7:00-22:00', 1, 1, 'available'),
