-- bake domain=DOM-SALON · tables in [6,15]
...
CREATE TABLE IF NOT EXISTS service (
  ...
  stylist_name VARCHAR(32) DEFAULT '',
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);
...
INSERT IGNORE INTO service (id, title, price_yuan, duration_note, category_id, stock, status) VALUES
