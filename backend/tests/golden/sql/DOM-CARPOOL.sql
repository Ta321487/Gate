...
INSERT IGNORE INTO trip_route (id, title, subtitle, detail, category_id, stock, status, owner_username) VALUES
...
UPDATE sys_user SET staff_post='carpool_clerk', staff_kind='clerk', nickname='对接员' WHERE username='subadmin' AND role='admin' AND IFNULL(super_admin,0)=0;
