-- bake domain=DOM-CRM · tables in [6,15]
...
UPDATE sys_user SET staff_post='account_mgr', staff_kind='clerk', nickname='客户经理' WHERE username='subadmin' AND role='admin' AND IFNULL(super_admin,0)=0;
