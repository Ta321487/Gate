-- bake domain=DOM-ACTIVITY · tables in [6,15]
...
UPDATE sys_user SET staff_post='assistant', staff_kind='clerk', nickname='活动助理' WHERE username='subadmin' AND role='admin' AND IFNULL(super_admin,0)=0;
