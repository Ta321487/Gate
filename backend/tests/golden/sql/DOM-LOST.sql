-- bake domain=DOM-LOST · tables in [6,13]
...
UPDATE sys_user SET staff_post='claim_clerk', staff_kind='clerk', nickname='招领管理员' WHERE username='subadmin' AND role='admin' AND IFNULL(super_admin,0)=0;
