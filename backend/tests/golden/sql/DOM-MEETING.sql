-- bake domain=DOM-MEETING · tables in [6,13]
...
UPDATE sys_user SET staff_post='booking_clerk', staff_kind='clerk', nickname='预约管理员' WHERE username='subadmin' AND role='admin' AND IFNULL(super_admin,0)=0;
