-- bake domain=DOM-PARKING · tables in [6,15]
...
('user', 'user123', 'user', '车主甲', '13800000002',
 '{"realName":"孙先生","email":"sun@demo.com","gender":"男","plateNo":"粤B12345","vehicleType":"小型车","ownerType":"月租","dept":"星河科技"}',
 0, 1, 1)
ON DUPLICATE KEY UPDATE nickname=VALUES(nickname), phone=VALUES(phone), profile_json=VALUES(profile_json);

INSERT IGNORE INTO category (id, name) VALUES (1, '地上'), (2, '地下');
INSERT IGNORE INTO space (id, title, fee_yuan, location_note, category_id, stock, status) VALUES
